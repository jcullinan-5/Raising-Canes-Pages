const Header = () => {
  return (
    <div className="layout-module--web-header--44872">
      <header className="header-module--web-header">
        <div className="header-module--container--d20b5">
          <a
            href="/home"
            className="header-module--icon--3d646 header-module--select-disable--ac458"
          >
            <div
          ...
          <nav className="header-module--navigation--9b62e">
            <ul>
              <li data-testid="nav-item">
                <a
                  data-testid="custom-link"
                  target="_self"
                  className="header-module--nav-link--301c3"
                  href="/menu"
                >
                  Our Menu
                </a>
          ...
          <div className="header-module--actions--86527">
            <a
              href="https://order.raisingcanes.com/"
              target="_blank"
              className="global-module--red-button--56e40 global-module--small--92e53"
              rel="noreferrer"
            >
              Order Now
            </a>
